...
import { ButtonType as R, WebPageController as ae, MenuEntryType as Y, WebItemsController as U, AppSize as C, FieldType as I, ColumnType as B, TableRowType as ne, TableType as L, ItemCrudButtonNavVisibility as le, ItemCrudMode as z, FormInstance as X, LktTranslationType as Q, FieldAutoValidationTrigger as te, AnchorType as fe, TablePermission as ke, MultipleOptionsDisplay as oe } from "lkt-vue-kernel";
...
import { createHTTPGetResource as Z, createHTTPPostResource as pe, createHTTPPutResource as me, createHTTPDeleteResource as ce } from "lkt-http-client";
const ge = /* @__PURE__ */ E({
  ...
  setup(o) {
    ...
    return (a, r) => {
      ...
      return n(u) ? (x(), N(s, j({
        key: 0,
        checked: n(e),
        "onUpdate:checked": r[0] || (r[0] = (c) => ve(e) ? e.value = c : null)
      }, {
  ...
  setup(o) {
    const e = G(), u = re(), a = l(e.params.type), r = l(e.params.id);
    O(e, (g) => {
  ...
  setup(o) {
    const e = o, u = M("lktAdminEnabled");
    u.value || (window.location.href = "/");
    const a = G(), r = re(), s = l(parseInt(a.params.id)), c = l(!1), g = l(!1), d = l(["create", "switch-edit-mode"]);
    let i = M("lktAppSize");
    i || (i = l(C.MD));
  ...
  setup(o) {
    const e = M("lktAdminEnabled"), u = o, a = G(), r = re(), s = l(a.params.type), c = l(a.params.id), g = l(!1), d = l(!1), i = l(["create"]), t = l(U.getWebItemSettings(s.value)), m = (p) => typeof t.value.itemGenerator == "function" ? t.value.itemGenerator(p) : {
      ...p
    }, f = l(m(a.query)), w = () => {
    ...
    const V = k(() => typeof t.value.appHeaderSingle < "u" ? {} : {
      ...
      return ((y = (p = t.value) == null ? void 0 : p.single) == null ? void 0 : y.createButton) === !1 ? !1 : {
        ...
        events: {
          click: (D) => {
            var F, A, K, J;
            typeof ((A = (F = t.value.single.createButton) == null ? void 0 : F.events) == null ? void 0 : A.click) == "function" && ((J = (K = t.value.single.createButton) == null ? void 0 : K.events) == null || J.click(D)), u.onCreateTo && r.push({
              path: u.onCreateTo,
              replace: !0
            });
          }
      ...
      return ((y = (p = t.value) == null ? void 0 : p.single) == null ? void 0 : y.createButton) === !1 ? !1 : {
        ...
        events: {
          click: (D) => {
            var F, A, K, J;
            typeof ((A = (F = t.value.single.createAndNewButton) == null ? void 0 : F.events) == null ? void 0 : A.click) == "function" && ((J = (K = t.value.single.createAndNewButton) == null ? void 0 : K.events) == null || J.click(D)), r.push({
  ...
  install: (o) => {
    o.component("lkt-admin-menu-button") === void 0 && o.component("lkt-admin-menu-button", ge), o.component("lkt-admin-menu") === void 0 && o.component("lkt-admin-menu", be);
  }
}, P = (o, e) => {
}, Ue = (o) => {
  o.addRoute({ path: "/admin/web-pages/:type", name: "lkt-admin-pages", component: _e, beforeEnter: P }), o.addRoute({ path: "/admin/web-pages/:type/:id", name: "lkt-admin-page", component: we, beforeEnter: P }), o.addRoute({ path: "/admin/web-items/:type", name: "lkt-web-items", component: Ae, beforeEnter: P }), o.addRoute({ path: "/admin/web-items/:type/:id", name: "lkt-web-item", component: Me, beforeEnter: P, props: (e) => ({
    id: e.params.id,
    type: e.params.type,
    onCreateTo: e.query.onCreateTo ?? ""
  }) }), o.addRoute({ path: "/admin/i18n", name: "lkt-admin-translations", component: ie, beforeEnter: P }), o.addRoute({ path: "/admin/i18n/:id", name: "lkt-admin-translation", component: ue, beforeEnter: P, props: (e) => ({
    onCreateTo: e.query.onCreateTo ?? ""
  }) }), o.addRoute({ path: "/admin/many-i18n", name: "lkt-admin-many-translations", component: ie, beforeEnter: P, props: (e) => ({
    many: !0
  }) }), o.addRoute({ path: "/admin/many-i18n/:id", name: "lkt-admin-many-translation", component: ue, beforeEnter: P, props: (e) => ({
    many: !0,
    onCreateTo: e.query.onCreateTo ?? ""
  }) });
};
